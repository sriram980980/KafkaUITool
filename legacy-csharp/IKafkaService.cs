namespace KafkaTool
{
    public interface IKafkaService
    {
        ...
        Task<List<KafkaMessage>> GetLatestMessagesAsync(string brokerUrls, string topic, int partition, int count);
        Task<List<KafkaMessage>> GetMessagesBetweenOffsetsAsync(string brokerUrls, string topic, int partition, long fromOffset, long toOffset);
